...
class PoolAndInject(torch.nn.Module):
    ...
    def forward(self,input):
        ...
        x = x.repeat(self.W,self.H)    #tile
        return torch.cat((x,input),0)  #skip-connection

class BasicBlock(torch.nn.Module):
    def __init__(self,num_inputs,n1,n2,n3,W,H):
        super(BasicBlock, self).__init__()
        self.pool_and_inject = PoolAndInject(W,H)
...
class MiniPacmanEnvModel(torch.nn.Module):
    def __init__(self, num_inputs, num_actions, use_cuda):
        ...
        self.basic_block1 = BasicBlock(num_inputs=64,n1=16,n2=32,n3=64,W=W,H=H)
        self.basic_block2 = BasicBlock(num_inputs=64, n1=16, n2=32, n3=64, W=W, H=H)
    ...
    def forward(self,input_frame,input_action):
        ...
        broadcasted_input_action = one_hot.repeat(15,19)       #tile

        x = torch.cat((input_frame, broadcasted_input_action),0)
