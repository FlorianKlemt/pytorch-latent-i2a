...
class CNNBase(nn.Module):
    def __init__(self, num_inputs, use_gru):
        ...
        self.conv_dims_after_downsampling = get_conv_output_dims([self.conv1, self.conv2, self.conv3], (200,160))   #TODO_remove hardcoding
        self.flat = Flatten()
        self.linear1 = nn.Linear(32*self.conv_dims_after_downsampling[0]*self.conv_dims_after_downsampling[1], 512)
