...
\newcommand{\PraesentationSeitenrand}{20mm}
...
\setbeamertemplate{frametitle}{%
    {\rule{0pt}{39mm + \PraesentationPositionKorrekturOben}\PraesentationSchriftgroesseSehrGross\selectfont\insertframetitle\newline\vspace*{-0.7mm}}%
}
