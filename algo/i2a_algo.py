...
class I2A_ALGO(object):
    ...
    def update(self, rollouts):
        ...
        rollout_policy_action_log_probs_var = F.log_softmax(rollouts.rollout_policy_action_probs, dim=2)
        # element-wise multiplication in the sum
        distill_loss = torch.sum(rollouts.policy_action_probs * rollout_policy_action_log_probs_var, dim=2)
