...
def main():
    ...
    num_autoencoder_inputs = 1 if args.use_only_last_frame_of_state else 4
    ...
    if args.train_batchwise:
        latent_space_trainer.train_env_encoder_batchwise(env, policy, latent_space_trainer, use_cuda)
    else:
