...
\begin{figure}[H] 
  \centering   
  \includegraphics[width=0.7\columnwidth]{./Images/hunt_environment_model_loss.png}
...
Figure \ref{fig:mini_pacman_regular_rewards} shows our training results for the reinforcement learning task MiniPacman Regular.
...
%The results of the original i2a paper have no improvement of i2a over the copy model in the mode "Regular" as shown in figure \ref{fig:mini_pacman_regular_original_rewards}.
